...
const DetailedCountry = ({ theme, country, onShowCountryDetails, onHideCountryDetails }) => {
    ...
    if (!theme) {
        ...
        return (
            <div className={cx(styles.detailedCountry, styles.dark)}>
                <button className={styles.buttonBack} onClick={onHideCountryDetails}> ← Back</button>
                <div className={styles.flag}>
                    <img src={country.flag} alt="" />
                </div> 
                <div className={styles.details}>
                    ...
                    <div className={styles.borderCountries}>
                        ...
                        <div className={styles.borders}>
                            {borderCountries.map((country) => (
                            <button className={cx(styles.buttonBorder, styles.buttonBackBlack)} key={country.alphaCode} onClick={() => onShowCountryDetails(country)}>{country.name}</button>
                            ))}
                        </div>
                    </div>
                </div>
